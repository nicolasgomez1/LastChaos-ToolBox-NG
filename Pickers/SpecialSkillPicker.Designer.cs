...
{
    partial class SpecialSkillPicker
	{
        /// <summary>
		...
		private void InitializeComponent()
		{
			...
			btnRemoveSkill.Location = new Point(349, 552);
			btnRemoveSkill.Margin = new Padding(4, 3, 4, 3);
			btnRemoveSkill.Name = "btnRemoveSkill";
			btnRemoveSkill.Size = new Size(262, 27);
			btnRemoveSkill.TabIndex = 1014;
			btnRemoveSkill.Text = "Remove Special Skill";
			...
			btnSelect.Location = new Point(8, 499);
			btnSelect.Margin = new Padding(4, 3, 4, 3);
			btnSelect.Name = "btnSelect";
			btnSelect.Size = new Size(247, 27);
			btnSelect.TabIndex = 1028;
			btnSelect.Text = "Select Special Skill && Level";
			btnSelect.UseVisualStyleBackColor = true;
			btnSelect.Click += btnSelect_Click;
			// 
			// cbLevelSelector
			// 
			cbLevelSelector.Anchor = AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
			...
			cbLevelSelector.Location = new Point(8, 470);
			cbLevelSelector.Margin = new Padding(4, 3, 4, 3);
			cbLevelSelector.Name = "cbLevelSelector";
			cbLevelSelector.Size = new Size(247, 23);
			cbLevelSelector.TabIndex = 1029;
			cbLevelSelector.SelectedIndexChanged += cbLevelSelector_SelectedIndexChanged;
			// 
			// pbIcon
			// 
			...
			groupBox1.Location = new Point(348, 14);
			groupBox1.Margin = new Padding(4, 3, 4, 3);
			groupBox1.Name = "groupBox1";
			groupBox1.Padding = new Padding(4, 3, 4, 3);
			groupBox1.Size = new Size(263, 532);
			groupBox1.TabIndex = 1030;
			groupBox1.TabStop = false;
			groupBox1.Text = "Special Skill Data";
			// 
			// rtbInformation
			// 
			...
			rtbInformation.Location = new Point(8, 60);
			...
			rtbInformation.Size = new Size(247, 404);
			...
			Name = "SpecialSkillPicker";
			ShowInTaskbar = false;
			Text = "Special Skill Picker";
