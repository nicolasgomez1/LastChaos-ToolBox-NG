namespace LastChaos_ToolBoxNG
{
	partial class OptionPicker
	{
		...
		private void InitializeComponent()
		{
			...
			btnRemoveOption.Size = new Size(263, 27);
			btnRemoveOption.TabIndex = 1014;
			btnRemoveOption.Text = "Remove Option";
			...
			groupBox1.Size = new Size(263, 534);
			...
			rtbInformation.Size = new Size(247, 444);
			...
			btnSelect.Text = "Select Option && Level";
